...
- (void)configureSubviews {
    ...
    [self.contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-left-[thumbnailView(thumbSize)]-right-[titleLabel(>=0)]-right-|" options:0 metrics:metrics views:views]];
    ...
    [self.contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-right-[thumbnailView(thumbSize)]-(>=0)-|" options:0 metrics:metrics views:views]];
}
